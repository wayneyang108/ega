...
and a morphism of simple complexes $\varepsilon: \cocx{L_0}\rightarrow \cocx{K}$, so that the conditions obtained from those of \sref{0.11.4.2} by `reversal arrows' are fulfilled.
...
that is to say formed of projective object $L_{ij}$, with the functorial properties similar to the \sref{0.11.4.2}.
...
are again done from \sref{0.11.4.3} by `reversal arrows', the $E^2$ terms of two spectral sequences are obtained similarly 
\[
  \label{0.11.6.2.1}
...
\sref{0.1.5} on the category $\cat{C'}$ due to the \emph{regular} condition of previous two sequences, which in this time requires to apply the criteria of \sref{0.11.3.4}.
...
\begin{proof}
The proof are like those of \sref{0.11.5.2}, \sref{0.11.4.5} and \sref{0.11.5.3} in the case of inf limit complexes. 
...
It results from the lemma \sref{0.11.5.2.1} (or instead the `dual' lemma obtained by `reversal arrows') and from (~M, ~V, ~2.2) that $\cobcx{K}$ admits a \emph{projective Cartan--Eilenberg resolution} 
...
With the notations of \sref{0.11.7.1}, the homology $\cocx{\HH}(T(\cotcx{M}))$ of simple complex associated to the tricomplex $T(\cotcx{M})$ is canonical isomorphic to 
the hypercohomology $\cocx{\LL} T(\cocx{K})$ of simple complex associated to $\cobcx{K}$ \sref{0.11.6.2}, and the abutment shared with six biregular spectral denoted by 
...
Thus it results from \sref{0.11.6.3} and \sref{0.11.6.4} that we have a functorial isomorphism $\cocx{\LL}(T(\cocx{L})) \simto \cocx{\HH}(T(\cobcx{N}))$;
...
In addition, $\cocx{\LL}(T(\cocx{L}))$ is the abutment of two hyperhomology spectral sequence \sref{0.11.6.2} of $T$ relatively to the simple complex $\cocx{L}$, 
...
Or, for all $i, \cobcx{M_i}$ is a bicomplex satisfied the conditions of \sref{0.11.6.3} relatively to the simple complex $\cocx{K_i}$;
...
apply \sref{0.11.6.3}, we see that we have
\[
...
\begin{remarks}[11.7.3]
\begin{enumerate}
  \item[(i)] It results from \sref{0.11.6.3} that $\cocx{\LL}T(\cobcx{K})$ is a \emph{homological functor} in the category of bicomplexes $\cobcx{K}$ of $\C$ inf limits in any of their degrees.
  ...
  In fact, with the notations of the proof of \sref{0.11.7.2}, $\cocx{N_i}$ is a resolution of $L_i$ such that $L_n T(N_{ij}) = 0$ for $n>0$ and all pair $(i,j)$, 
  and it suffices to apply \sref{0.11.6.3, (iii)}.
\oldpage[0\textsubscript{III}]{43}
  \item[(iii)]  We generalize immediately the results of \sref{0.11.7.2} to covariant multifunctor;
  ...
  apply \sref{0.11.6.4} and \sref{0.11.6.5}, we have of the same that in \sref{0.11.7.2} six spectral sequences abutment to this hyperhomology, 
...
Similarly, with the help of the homomorphisms $\cocx{L}(A)\rightarrow\cocx{C}(A)$ and $\cocx{L}(B)\rightarrow\cocx{C}(B)$ defined in \sref{0.11.8.1} 
